...
def euler_angles_to_koordinates(theta, phi,r, upangle):
    camera_koordinates[0] = r * math.sin(theta) * math.cos(phi)  # Kugleformel mit Winkeln zur Kamerasteuerung
    camera_koordinates[1] = r * math.sin(theta) * math.sin(phi)
    camera_koordinates[2] = r * math.cos(theta)
